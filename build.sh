...
# =============================================================================
#
# VERSION: Compatible with Beranode v0.5.0
#
# PURPOSE:
...
#   architecture introduced in v0.5.0+ while maintaining a single-file
...
echo -e "${BLUE}Building beranode CLI v0.5.0...${RESET}"
...
modules=(
	...
	"commands/common.sh"   # [4.6] Common command utilities
	"commands/init.sh"     # [4.7] Init command implementation
	"commands/start.sh"    # [4.8] Start command implementation
	"commands/stop.sh"     # [4.9] Stop command implementation
...
echo -e "${BLUE}  Version: v0.5.0${RESET}"
echo -e "${BLUE}  Lines: $(wc -l <"$OUTPUT_FILE")${RESET}"
echo -e "${BLUE}  Size: $(du -h "$OUTPUT_FILE" | cut -f1)${RESET}"

# =============================================================================
# VERSION CONTEXT FOR v0.5.0
# =============================================================================
#
# This build script was designed for beranode v0.5.0, which includes:
#
