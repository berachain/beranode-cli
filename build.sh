...
# =============================================================================
#
# VERSION: Compatible with Beranode v0.6.0
#
# PURPOSE:
...
#   architecture introduced in v0.6.0+ while maintaining a single-file
...
echo -e "${BLUE}Building beranode CLI v0.6.0...${RESET}"
...
modules=(
  ...
  "lib/download.sh"      # [4.6] Download utilities
...
echo -e "${BLUE}  Version: v0.6.0${RESET}"
echo -e "${BLUE}  Lines: $(wc -l <"$OUTPUT_FILE")${RESET}"
echo -e "${BLUE}  Size: $(du -h "$OUTPUT_FILE" | cut -f1)${RESET}"

# =============================================================================
# VERSION CONTEXT FOR v0.6.0
# =============================================================================
#
# This build script was designed for beranode v0.6.0, which includes:
#
