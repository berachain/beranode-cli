...
#
# CHANGELOG (Recent):
#   v0.2.1 - Added --help flag support for init and start commands
#   v0.2.0 - Implemented semantic versioning (semver) support
...
main() {
	...
	# Added in: v0.2.1 with enhanced --help support
	# ---------------------------------------------------------------------
	-h | --help | help)
		show_help
		;;
	...
	validate)
		...
		# Added: v0.2.1 with regex-based validation
		cmd_validate "$@"
		;;
