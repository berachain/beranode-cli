...
#
# CHANGELOG (Recent):
#   v0.7.1 - Added --help flag support for init and start commands
#   v0.7.1 - Implemented semantic versioning (semver) support
...
main() {
	...
	# Added in: v0.7.1 with enhanced --help support
	# ---------------------------------------------------------------------
	-h | --help | help)
		show_help
		;;
	...
	init)
		...
		# Added: v0.1.x, Enhanced: v0.7.1 with --help flag
		cmd_init "$@"
		;;
	start)
